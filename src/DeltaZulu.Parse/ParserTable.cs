...
/// </summary>
internal delegate int ConstructFunc(ParseContext ctx, JsonObject config, out object? pdata);

/// <summary>
/// Parse function of a motif parser.
/// </summary>
/// <param name="npb">the parse parameter block (message + state)</param>
...
internal static class ParserTable
{
    ...
    public static readonly ParserInfo[] Parsers =
    {
        ...
        new() { Name = "kernel-timestamp", Priority = 16, Construct = DateTimeParsers.ConstructKernelTimestamp, Parse = DateTimeParsers.ParseKernelTimestamp },
        ...
        new() { Name = "date-iso", Priority = 8, Construct = DateTimeParsers.ConstructIsoDate, Parse = DateTimeParsers.ParseIsoDate },
        new() { Name = "time-24hr", Priority = 8, Construct = DateTimeParsers.ConstructTime24hr, Parse = DateTimeParsers.ParseTime24hr },
        new() { Name = "time-12hr", Priority = 8, Construct = DateTimeParsers.ConstructTime12hr, Parse = DateTimeParsers.ParseTime12hr },
        new() { Name = "duration", Priority = 16, Construct = DateTimeParsers.ConstructDuration, Parse = DateTimeParsers.ParseDuration },
    ...
    internal static bool IsCatalogFullMatch(string parserName, ReadOnlySpan<char> sample)
    {
        ...
        var npb = new Npb { Ctx = new ParseContext(), Snap = EmptySnapshot, Str = input };
        var offset = 0;
        JsonNode? value = null;
