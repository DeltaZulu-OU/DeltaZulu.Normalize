...
/// <summary>
/// <para>
/// The flat result of a parse: an ordered list of extracted fields
...
public sealed class ParseResult
{
    ...
    internal ParseResult(int status, FieldCollector fields)
    {
        Status = status;
        _fields = fields;
    }
    ...
    /// <summary>The parse status code: 0 on a match, non-zero otherwise (C-compatible).</summary>
    ...
    /// <summary>Compact JSON text (same format as <see cref="ParseContext.ParseToString"/>).</summary>
